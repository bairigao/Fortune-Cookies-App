...
public class UserTest {
    ...
    private static final String SecureQuestion_TWO = "What is your favorite food?";
    private static final String SecureAnswer = "niuyou";
    private static final String SecureAnswer_TWO = "egg";
